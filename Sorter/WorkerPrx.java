...
public interface WorkerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        processData(data, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void processData(String data, java.util.Map<String, String> context)
    {
        _iceI_processDataAsync(data, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> processDataAsync(String data)
    {
        return _iceI_processDataAsync(data, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> processDataAsync(String data, java.util.Map<String, String> context)
    {
        return _iceI_processDataAsync(data, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_processDataAsync(String iceP_data, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "processData", null, sync, null);
