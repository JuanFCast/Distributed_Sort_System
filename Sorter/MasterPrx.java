...
{
    default void distributeWork(String[] data)
    {
        distributeWork(data, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void distributeWork(String[] data, java.util.Map<String, String> context)
    {
        _iceI_distributeWorkAsync(data, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> distributeWorkAsync(String[] data)
    {
        return _iceI_distributeWorkAsync(data, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> distributeWorkAsync(String[] data, java.util.Map<String, String> context)
    {
        return _iceI_distributeWorkAsync(data, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_distributeWorkAsync(String[] iceP_data, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "distributeWork", null, sync, null);
    ...
    default void startSorting(String filePath)
    {
        startSorting(filePath, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void startSorting(String filePath, java.util.Map<String, String> context)
    {
        _iceI_startSortingAsync(filePath, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> startSortingAsync(String filePath)
    {
        return _iceI_startSortingAsync(filePath, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> startSortingAsync(String filePath, java.util.Map<String, String> context)
    {
        return _iceI_startSortingAsync(filePath, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_startSortingAsync(String iceP_filePath, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "startSorting", null, sync, null);
        f.invoke(false, context, null, ostr -> {
    ...
    default String[] getSortedResults()
    {
        return getSortedResults(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String[] getSortedResults(java.util.Map<String, String> context)
    {
        return _iceI_getSortedResultsAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<String[]> getSortedResultsAsync()
    {
        return _iceI_getSortedResultsAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<String[]> getSortedResultsAsync(java.util.Map<String, String> context)
    {
        return _iceI_getSortedResultsAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<String[]> _iceI_getSortedResultsAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<String[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getSortedResults", null, sync, null);
